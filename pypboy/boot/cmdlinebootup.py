...
class CmdLineClass:
    def __init__(self, *args, **kwargs):
        ...
        self.canvas = pygame.Surface(self.parent.native_size)
        ...
        if config.QUICKLOAD:
            ...
            for char in thisLine:
                ...
                if (math.fmod(charNum, 6) == 0) or (lastChar):
                    # --- FIX: Check if the sound was successfully loaded before playing ---
                    if config.SOUND_ENABLED and "changemode" in config.SOUNDS:
